...
if ($count >= 1){
 ...
 switch($idiotita){
	 ...
	 case "hub":{ echo 'ok'; $_SESSION['name']=$name; $_SESSION['lastname']=$lastname; header('Location: hub/main_hub.php'); break; }
	 default:{ header('Location: mobile_logon.html'); }
 }
}else{
 session_destroy();
 header('Location: mobile_logon.html');
 }
