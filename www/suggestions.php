...
if ($q !== "") {
    ...
    foreach($poli as $name) {
        if (stristr($q, substr($name, 0, $len))) {
			...
			echo "<div style='border:2px; width:55%; border-color:darkred; border-style:inset; border-radius:8px; border-color:black'><strong style='color:darkred'>".$l.") Πόλη: ".$name."</strong><hr>Ονομασία Καταστήματος: ".$onomasia[$j]."<br>Οδός: ".$odos[$j]." ".$arithmos[$j]."<br>Τηλέφωνο: ".$tilefono[$j]."<br>TK: ".$tk[$j]."</div><br>";
$l++;       
	   }
		$j++;
    }
