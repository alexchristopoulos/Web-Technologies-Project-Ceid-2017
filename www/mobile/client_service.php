...
<div id="welcomediv" style="padding:8px; padding-top:15px;"><strong>
...
<!-- _________________________________________________________________________________________________________________________ -->
<div id="apostoli" style="display:none">
...
<div id="displayinfo" style="display:block; width:95%; height:50%; padding:4px; ">
