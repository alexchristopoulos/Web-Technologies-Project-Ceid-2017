...
<!-- enimerosi dematos -->
<div id="infodel" style="display:block;">
...
<center><input type="submit" id="loadinfo"  value="Συνέχεια" style =" border-radius : 5px; display:block; background-color:darkblue; color:white;"></center></input>
</form>
<div id="displayinfo" style="display:block; width:95%; padding:4px;">
<?php
$db_server["host"] = "localhost"; //database server
$db_server["username"] = "root"; // DB username
$db_server["password"] = ""; // DB password
...
echo "Τοποθεσίες Που Έχει Περάσει(Ονομασίες Καταστημάτων/Hubs): ";
...
?></div>
<div id="map_canvas" style="display:block; width:700px; height:400px; position: relative; left: 0%;"></div><script>
<?php
$indx;
$db_server["host"] = "localhost"; //database server
$db_server["username"] = "root"; // DB username
